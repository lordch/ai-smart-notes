...
MODULE 1: The Paradigm Shift (2h)
...
**Kluczowy insight:**
> "Chat interfaces position AI as a respondent. You ask, it answers. Task queues position AI as your worker. You delegate, it executes, you review."

### Demo:
Pokazanie tego samego zadania w obu paradygmatach:
- Chat: 5 promptów, kopiowanie, formatowanie
- Agent: 1 zadanie, plan, wykonanie, gotowy artefakt

## 1.2 From Editing Loop to Steering Loop
...
4. **Async execution**
   - Task queue wymusza przemyślenie
   - Nie "ping-pong" promptów
...
2. Dla każdego określ:
   - Czy to jest "conversation" czy "delegation"?
...
| **Steering loop** | Human guides direction, agent executes |
| **Editing loop** | Human fixes AI output iteratively |
...
- [ ] Articulate the shift from chat to delegation
